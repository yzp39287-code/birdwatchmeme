...
loginBtn.onclick=async()=>{if(!client){alert("网站管理员尚未完成 Supabase 配置。");return}await client.auth.signInWithOAuth({provider:"github",options:{redirectTo:new URL(".",location.href).href}})};
